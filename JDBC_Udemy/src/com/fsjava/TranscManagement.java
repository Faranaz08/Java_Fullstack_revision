...
/*
USE learn;  -- Switch to the 'learn' database

CREATE TABLE account (
    accno INT PRIMARY KEY,          -- Account number
    accbal DOUBLE,                  -- Account balance
    accname VARCHAR(100)            -- Account holder's name
);

-- Inserting sample account data
INSERT INTO account (accno, accbal, accname) VALUES (101, 5000.00, 'Alice');
INSERT INTO account (accno, accbal, accname) VALUES (102, 3000.00, 'Bob');
INSERT INTO account (accno, accbal, accname) VALUES (103, 7000.00, 'Charlie');
INSERT INTO account (accno, accbal, accname) VALUES (104, 6000.00, 'David');
*/
